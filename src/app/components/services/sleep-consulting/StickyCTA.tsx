...
export default function StickyCTA() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            // Show after scrolling past 600px (approx hero + empathy height)
    ...
    return (
        <>
            ...
            <div className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-slide-up w-full px-8 max-w-[320px]">
                <Link
                    href="/contact?service=sleep-consulting"
            ...
            <div className="hidden md:block fixed bottom-8 right-8 z-50 animate-fade-in">
                ...
                >
                    <span className="font-hand text-xl text-terracotta">Book Discovery Call</span>
